...
class VideoProcessor {
    ...
    private $ffmpegPath;
    //private $ffmpegPath = "ffmpeg/mac/xampp-VM/ffmpeg"; // *** Sử dụng MAC ***
    // private $ffmpegPath = "ffmpeg/linux/ffmpeg"; // *** Sử dụng LINUX ***

    private $ffprobePath;
    //private $ffprobePath = "ffmpeg/mac/xampp-VM/ffprobe"; // *** Sử dụng MAC ***
    // private $ffprobePath = "ffmpeg/linux/ffprobe"; // *** Sử dụng LINUX ***
